...
```{r}
ExtractPerPupilWide <- function(field) 
{
  districtsYears                               %>%
...
```{r}
FTEWide  <- ExtractPerPupilWide(`FTE Enroll`)
nrow(FTEWide)
```                
Sample data
...
```{r}
CapitalOutlayExpendPerPupilWide  <- ExtractPerPupilWide(`Capital Outlay`)
...
```{r}
BondInterestExpendPerPupilWide  <- ExtractPerPupilWide(`Bond Interest`)
...
```{r}
AllOthersExpendPerPupilWide  <- ExtractPerPupilWide(`All Others`)
...
```{r}
TotalExpendPerPupilWide  <- ExtractPerPupilWide(`Total Expend`)
